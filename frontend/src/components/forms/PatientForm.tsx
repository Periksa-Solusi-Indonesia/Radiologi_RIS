...
interface PatientFormProps {
  onSubmit: (data: PatientFormValues, files: File[]) => Promise<void>
  isLoading?: boolean
}
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Enter patient information and upload any relevant documents.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Relevant medical history..." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
